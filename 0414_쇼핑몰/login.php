			...
			<div class="container">
              ...
              <form name="loginForm" action="./php/login_check.php" method="POST" onsubmit="return Form_check();">
                <p>
                  ...
                  <input type="text" placeholder="아이디" name="mb_id" id="mb_id">
                </p>
								<p>
                  <label for="pw">패스워드 : </label>
                  <input type="password" placeholder="비밀번호" name="mb_pw" id="mb_pw">
                </p>
                <p class="id_save">
                ...
                <p>
                  <a href="javascript:void(0)" onclick="kakaoLogin()">카카오로그인</a>
                </p>
              </form>
            </div>
					</div>
...
<script>
  Kakao.init('9ba2c8e07c8bea930276340e45c3623b');
// sdk초기화여부판단 
//카카오로그인 
function kakaoLogin() {
